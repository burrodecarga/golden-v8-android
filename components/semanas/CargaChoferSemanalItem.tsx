...
interface CargaItemProps {
    item: ResumenChoferesProps
    ver?: 'cobrado'|'no cobrado'|'todos'
}
const CargaChoferSemanalItem=({ item, ver }: CargaItemProps) => {


    return (
        <View style={styles.container} key={item.chofer+'-'+item.semana}>
            <View style={{ flexDirection: 'column', justifyContent: 'space-between', alignItems: 'flex-start', alignContent: 'center' }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Ionicons name='person-circle' size={14} />
            ...
            <View style={{ flexDirection: 'column', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: 12 }}>Gastos Reportados : </Text>
                    <Text style={{ fontSize: 12 }}>{item.total_gastos}</Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Ionicons name='add-circle-outline' size={14} color='red' />
                    <Text style={{ fontSize: 12 }}>Gastos Estimado : </Text>
...
export default CargaChoferSemanalItem